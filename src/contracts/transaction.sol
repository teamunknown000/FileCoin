...
contract TeamUnknown{
    ...
    function listTransactions(
        ...
        transactions.push(Transactions(_buyer, _seller, _product, _quantity, _price, _offer));
    }

    function getListedTransactions() public view returns(Transactions[] memory){
        return transactions;
    }
}